...
* **7. Install Nginx web server (w/ Puppet)**
  * Using Puppet to install and configure an Nginx server instead of Bash. To save time and effort, you should also include resources in your manifest to perform a 301 redirect when querying /redirect_me.
